        ...
        <div className="divider-list-wrap">
          <div className="divider-list-wrap-flex">
            <div className="d-flex justify-content-between align-items-center">
              ...
              <div className="fs-6 text-dark fw-semibold">Mechanic</div>
            </div>
          </div>
            ...
            <div className="d-flex justify-content-between align-items-center">
              ...
              <div className="d-flex align-items-center gap-4">
                <div>
                  ...
                  <div className="fs-6 text-muted">Street Name</div>
                </div>
                <div>
                  <div className="small text-dark">Locality</div>
                  <div className="fs-6 text-muted">Locality</div>
                </div>
                <div>
                  <div className="small text-dark">City/Post Town</div>
                  <div className="fs-6 text-muted">City/Post Town</div>
                </div>
                <div>
                  <div className="small text-dark">Post Code</div>
                  <div className="fs-6 text-muted">Post Code</div>
                </div>
              </div>
            </div>
          </div>
