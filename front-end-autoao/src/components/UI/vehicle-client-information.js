const VehicleClientInformation = ({ client }) => {
	return (
		<>
			<div className="divider-list">
				<div className="divider-list-wrap">
					<div className="divider-list-wrap-flex">
						<div className="d-flex justify-content-between align-items-center">
							<div className="fs-6 text-dark">Name</div>
							<div className="fs-6 text-dark fw-semibold">{client?.name}</div>
						</div>
					</div>
					...
					<div className="divider-list-wrap-flex">
						<div className="d-flex justify-content-between align-items-center">
							<div className="fs-6 text-dark">Email</div>
				...
				<div className="divider-list-wrap">
					...
					<div className="divider-list-wrap-flex">
						<div className="d-flex justify-content-between align-items-center">
							<div className="fs-6 text-dark">Vehicle/s owned</div>
							<div className="fs-6 fw-medium text-dark d-flex align-items-center gap-2">
								{client?.regPlate}
							</div>
						</div>
...
export default VehicleClientInformation;
